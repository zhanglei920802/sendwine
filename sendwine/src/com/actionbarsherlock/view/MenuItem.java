...
public interface MenuItem {
	...
	public interface OnActionExpandListener {
		 ...
		 *         suppressed.
		 *         {@link MenuItem#SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW} is
		 *         expanded.
		 */
	 ...
	 * 
	 * @return The order of this item. {@link Menu#CATEGORY_SECONDARY},
	 *         {@link Menu#CATEGORY_ALTERNATIVE},
	 *         {@link Menu#CATEGORY_CONTAINER}. See {@link Menu} for a full
	 *         list.
	 */
	public int getOrder();
	 ...
	 * @return This Item so additional setters can be called. {@link Menu} for
	 *         the menu types that support icons.
	 */
	 ...
	 *         the menu types that support icons.
	 *         <p>
	 *         This method will set the resource ID of the icon which will be
	 *         used to lazily get the Drawable when this item is being shown.
	 */
	 ...
	 * @return This Item so additional setters can be called.
	 *         {@link android.content.Context#startActivity} with the given
	 *         Intent.
	 * 
	 *         <p>
	 *         Note that setIntent() can not be used with the versions of
	 *         {@link Menu#add} that take a Runnable, because
	 *         {@link Runnable#run} does not return a value so there is no way
	 *         to tell if it handled the item. In this case it is assumed that
	 *         the Runnable always handles the item, and the intent will never
	 *         be started.
	 * @see #getIntent
	 */
	 ...
	 * @return This Item so additional setters can be called.
	 *         {@link Menu#setGroupCheckable(int, boolean, boolean)}, the other
	 *         items in the group will be unchecked.
	 *         <p>
	 *         See {@link Menu} for the menu types that support check marks.
	 * @see #setCheckable
	 * @see #isChecked
	 ...
	 *            {@link #SHOW_AS_ACTION_WITH_TEXT}. SHOW_AS_ACTION_WITH_TEXT
	 *            requests that when the item is shown as an action, it should
	 *            be shown with a text label. {@link #SHOW_AS_ACTION_ALWAYS},
	 ...
	 *         {@link #SHOW_AS_ACTION_WITH_TEXT}. SHOW_AS_ACTION_WITH_TEXT
	 *         requests that when the item is shown as an action, it should be
	 *         shown with a text label.
	 * 
	 *         <p>
	 *         Note: This method differs from {@link #setShowAsAction(int)} only
	 *         in that it returns the current MenuItem instance for call
	 *         chaining. {@link #SHOW_AS_ACTION_ALWAYS},
	 *         {@link #SHOW_AS_ACTION_IF_ROOM}, or {@link #SHOW_AS_ACTION_NEVER}
	 ...
	 *         {@link #SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW}. If a listener has
	 *         been set using
	 *         {@link #setOnActionExpandListener(OnActionExpandListener)} it
	 *         will have its
	 *         {@link OnActionExpandListener#onMenuItemActionExpand(MenuItem)}
	 *         method invoked. The listener may return false from this method to
	 *         prevent expanding the action view.
	 */
	 ...
	 *         {@link #setOnActionExpandListener(OnActionExpandListener)} it
	 *         will have its
	 *         {@link OnActionExpandListener#onMenuItemActionCollapse(MenuItem)}
	 *         method invoked. The listener may return false from this method to
	 *         prevent collapsing the action view.
	 */
