...
public interface Menu {
	 ...
	 * @param title
	 *            The text to display for the item.
	 * @return The newly added sub-menu {@link SubMenu#getItem()}.
	 */
	 ...
	 *         {@link Intent#CATEGORY_SELECTED_ALTERNATIVE} to find activities
	 *         that have said they would like to be included as optional action.
	 *         You can, however, use any Intent you want.
	 * 
	 *         <p>
	 *         See
	 *         {@link android.content.pm.PackageManager#queryIntentActivityOptions}
	 *         for more * details on the <var>caller</var>,
	 *         <var>specifics</var>, and <var>intent</var> arguments. The list
	 *         returned by that function is used to populate the resulting menu
	 *         items.
	 * 
	 *         <p>
	 *         All of the menu items of possible options for the intent will be
	 *         added with the given group and id. You can use the group to
	 *         control ordering of the items in relation to other items in the
	 *         menu. Normally this function will automatically remove any
	 *         existing items in the menu in the same group and place a divider
	 *         above and below the added items; this behavior can be modified
	 *         with the <var>flags</var> parameter. For each of the generated
	 *         items {@link MenuItem#setIntent} is called to associate the
	 *         appropriate Intent with the item; this means the activity will
	 *         automatically be started for you without having to do anything
	 *         else.
