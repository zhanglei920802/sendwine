...
public abstract class ActionBar {
	 ...
	 * 
	 * @param title
	 *            Title to set {@link #DISPLAY_SHOW_TITLE} is set.
	 * @see #setTitle(int)
	 * @see #setDisplayOptions(int, int)
	 */
	 ...
	 * 
	 * @param resId
	 *            Resource ID of title string to set {@link #DISPLAY_SHOW_TITLE}
	 *            is set.
	 * @see #setTitle(CharSequence)
	 * @see #setDisplayOptions(int, int)
	 */
	 ...
	 * 
	 * @param subtitle
	 *            Subtitle to set {@link #DISPLAY_SHOW_TITLE} is set. Set to
	 ...
	 *            defined in ActionBar. {@link #setDisplayOptions(int, int)}.
	 */
	 ...
	 * 
	 *            <p>
	 *            Example: setDisplayOptions(0, DISPLAY_SHOW_HOME) will disable
	 *            the {@link #DISPLAY_SHOW_HOME} option.
	 *            setDisplayOptions(DISPLAY_SHOW_HOME, DISPLAY_SHOW_HOME |
	 *            DISPLAY_USE_LOGO) will enable {@link #DISPLAY_SHOW_HOME} and
	 *            disable {@link #DISPLAY_USE_LOGO}.
	 */
	 ...
	 * 
	 * @return The current ActionBar title or null. {@link #getNavigationMode()}
	 ...
	 * 
	 * @param tab
	 *            Tab to select {@link #setSelectedNavigationItem(int)}.
	 *            </p>
	 */
