...
public abstract class IcsAdapterView<T extends Adapter> extends ViewGroup {
	...
	/**
	 * Instantiates a new ics adapter view.
	 * 
	 * @param context
	 *            the context
	 */
	...
	*/
	...
	/** 
	* <p>Title: setFocusableInTouchMode</p> 
	* <p>Description: </p> 
	* @param focusable 
	...
	*/
	...
	/** 
	* <p>Title: onRequestSendAccessibilityEvent</p> 
	* <p>Description: </p> 
	* @param child
	* @param event
	* @return 
	* @see android.view.ViewGroup#onRequestSendAccessibilityEvent(android.view.View, android.view.accessibility.AccessibilityEvent) 
	*/
	@Override
	...
	/** 
	* <p>Title: onInitializeAccessibilityNodeInfo</p> 
	* <p>Description: </p> 
	* @param info 
	* @see android.view.View#onInitializeAccessibilityNodeInfo(android.view.accessibility.AccessibilityNodeInfo) 
	*/
	@Override
