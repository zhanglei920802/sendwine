...
public class ActionBarView extends AbsActionBarView {
	...
	/** The Constant DEFAULT_CUSTOM_GRAVITY. */
	private static final int DEFAULT_CUSTOM_GRAVITY = Gravity.LEFT
			| Gravity.CENTER_VERTICAL;

	/** The m navigation mode. */
	private int mNavigationMode;
	
	/** The m display options. */
	...
	/** The m indeterminate progress style. */
	...
	/** The m expanded menu presenter. */
	private ExpandedActionViewMenuPresenter mExpandedMenuPresenter;
	
	/** The m expanded action view. */
	View mExpandedActionView;

	/** The m window callback. */
	Window.Callback mWindowCallback;

	/** The m nav item selected listener. */
	...
	/** The m expanded action view up listener. */
	...
	/** The m up click listener. */
	private final OnClickListener mUpClickListener = new OnClickListener() {
		@Override
		public void onClick(View v) {
			mWindowCallback.onMenuItemSelected(
					android.view.Window.FEATURE_OPTIONS_PANEL, mLogoNavItem);
		}
	};

	/**
	 * Instantiates a new action bar view.
	 * 
	 * @param context
	 *            the context
	 * @param attrs
	...
	public ActionBarView(Context context, AttributeSet attrs) {
		...
		mTitle = a.getText(R.styleable.SherlockActionBar_title1);
		mSubtitle = a.getText(R.styleable.SherlockActionBar_subtitle1);
	...
	* <p>Description: </p> 
	* @param newConfig 
	* @see com.actionbarsherlock.internal.widget.AbsActionBarView#onConfigurationChanged(android.content.res.Configuration) 
	*/
	@Override
	...
	*/
	...
	/**
	 * Inits the indeterminate progress.
	 */
	...
	*/
	...
	/**
	 * Checks if is split action bar.
	 * 
	 * @return true, if is split action bar
	 */
	...
	/**
	 * Sets the embedded tab view.
	 * 
	 * @param tabs
	 *            the new embedded tab view
	 */
	...
	/**
	 * Checks for expanded action view.
	 * 
	 * @return true, if successful
	 */
	...
	/**
	 * Sets the custom navigation view.
	 * 
	 * @param view
	 *            the new custom navigation view
	 */
	...
	/**
	 * Sets the dropdown adapter.
	 * 
	 * @param adapter
	 *            the new dropdown adapter
	 */
	...
	/**
	 * Gets the dropdown adapter.
	 * 
	 * @return the dropdown adapter
	 */
	...
	/**
	 * Sets the dropdown selected position.
	 * 
	 * @param position
	 *            the new dropdown selected position
	 */
	...
	/**
	 * Gets the dropdown selected position.
	 * 
	 * @return the dropdown selected position
	 */
	...
	/**
	 * Gets the custom navigation view.
	 * 
	 * @return the custom navigation view
	 */
	...
	*/
	...
	static class SavedState extends BaseSavedState {
		...
		/** The expanded menu item id. */
		int expandedMenuItemId;
		
		/** The is overflow open. */
	...
	public static class HomeView extends FrameLayout {
		...
		/** 
		* <p>Title: dispatchPopulateAccessibilityEvent</p> 
		* <p>Description: </p> 
		* @param event
		* @return 
		...
		*/
		...
		/** 
		* <p>Title: onPopulateAccessibilityEvent</p> 
		* <p>Description: </p> 
		* @param event 
	...
	/**
	 * The Class ExpandedActionViewMenuPresenter.
	 */
