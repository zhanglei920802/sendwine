...
public class MainActivity extends MainBaseActivity {
	...
	// �������
	private String[] hotData = new String[] { "����Һ", "ę́", "��̩", "����Һ", "ę́",
			"��̩"
	...
	public void initData() {
...

		{
			...
			mCategorys.add(new Category("�׾�", "����Һ,¶���Ͻѵ�����Һ,¶���Ͻѵ�����Һ,¶���Ͻѵ�"));
...

		{
			...
			mArticles
					.add(new com.sendwine.app.bean.Article("�й�׾Ƶķ�չ��ʷ",
							"�й�׾Ƶķ�չ��ʷ�й�׾Ƶķ�չ��ʷ�й�׾Ƶķ�չ��ʷ�й�׾Ƶķ�չ��ʷ�й�׾Ƶķ�չ��ʷ�й�׾Ƶķ�չ��ʷ�й�׾Ƶķ�չ��ʷ�й�׾Ƶķ�չ��ʷ"));
		...
		{
			{
				...
				mCartBeans.add(new CartBean(1, true, "����Һ", "3333", "33333",
						5.0f, "baidu.com", 1));
				mCartBeans.add(new CartBean(1, true, "����Һ", "3333", "33333",
						5.0f, "baidu.com", 2));
				mCartBeans.add(new CartBean(1, true, "����Һ", "3333", "33333",
...

		{
...

			{
				...
				check_gloab.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						if (flag == 0) {
							...
							select(false);
							flag = 1;
							check_gloab.setText("ȫѡ");
						} else {
							// selectall
							select(true);
							check_gloab.setText("ȫ��ѡ");
							flag = 0;
						}
					}
				});
				...
				payout.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						Toast.makeText(mAppContext, "֧��", Toast.LENGTH_SHORT)
								.show();
					}
				});
