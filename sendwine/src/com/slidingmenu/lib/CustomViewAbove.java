...
public class CustomViewAbove extends ViewGroup {
	...
	public static class SimpleOnPageChangeListener implements
		...
		/** 
		* <p>Title: onPageScrolled</p> 
		* <p>Description: </p> 
		* @param position
		* @param positionOffset
		* @param positionOffsetPixels 
		* @see com.slidingmenu.lib.CustomViewAbove.OnPageChangeListener#onPageScrolled(int, float, int) 
		*/
		@Override
		public void onPageScrolled(int position, float positionOffset,
				int positionOffsetPixels) {
		...
		* <p>Description: </p> 
		* @param position 
		* @see com.slidingmenu.lib.CustomViewAbove.OnPageChangeListener#onPageSelected(int) 
		*/
		@Override
		public void onPageSelected(int position) {
			// This space for rent
